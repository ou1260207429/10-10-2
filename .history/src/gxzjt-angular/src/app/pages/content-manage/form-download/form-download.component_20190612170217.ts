...
import { RegulationServiceProxy, AttachmentServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class FormDownloadComponent implements OnInit {
  ...
  add() {
    this.router.navigate([`/app/content-manage/formDownloadDetailComponent/1`, { operate: 0 }]);
  }
