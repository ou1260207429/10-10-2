...
export class HandlingGuideComponent implements OnInit {
  ...
  validateForm: any;
  constructor(private _noticeServiceProxy:NoticeServiceProxy ,private _regulationServiceProxy: RegulationServiceProxy, private router: Router, private eventEmiter: EventEmiter) {
  }
