...
import { NoticeServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class HandlingGuideComponent implements OnInit {
  ...
  constructor(private _nodeServiceProxy: NoticeServiceProxy   , private router: Router, private _eventEmiter: EventEmiter) {
  }
  ...
  query_noticeList(params?: any) {
    this.data = "";
    this._nodeServiceProxy.noticeListAsync(params).subscribe(data => {
      this.data = data;
    })
  }
