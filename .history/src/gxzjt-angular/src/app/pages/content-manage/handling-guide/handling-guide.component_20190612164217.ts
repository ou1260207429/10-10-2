import { NoticeDto } from './../../../../../../../.history/src/gxzjt-angular/src/shared/service-proxies/service-proxies_20190611200128';
...
export class HandlingGuideComponent implements OnInit {
  ...
  constructor(private _oticeDto:NoticeDto,private _regulationServiceProxy: RegulationServiceProxy, private router: Router, private _eventEmiter: EventEmiter) {
  }
