...
export class HandlingGuideComponent implements OnInit {
  ...
  columns: STColumn[] = [
    ...
    {
      title: '操作人', index: 'lastUpdateUserName', type: 'date'
    },
    {
      title: '最近操作时间', index: 'lastModificationTime', type: 'date'
    },
    {
      title: '操作人账号', index: 'lastUpdateUserCode', type: 'date'
    },
    {
  ...
  add() {
    this.router.navigate([`/app/content-manage/handlingGuidDetailComponent/1`]);
  }
