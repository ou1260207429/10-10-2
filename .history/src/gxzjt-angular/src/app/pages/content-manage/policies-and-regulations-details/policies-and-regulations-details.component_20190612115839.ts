...
export class PoliciesAndRegulationsDetailsComponent implements OnInit {
  ...
  getRegulationDetailsByIdAsync() {
    ...
    this._regulationServiceProxy.getRegulationDetailsByIdAsync(this.regulationId).subscribe((data: any) => {
      ...
      // content: "<p>9997777</p>"
      // contentUrl: null
      // creationTime: "2019-06-12T03:52:05.415Z"
      // guid: "7E7C9459-EB20-47B0-89C5-7EACBBA8D754"
      // id: 27
      // issueDate: "2019-06-12T03:54:30.885Z"
      // issueOrg: "88"
      // lastUpdateUserCode: ""
      // lastUpdateUserName: ""
      // regulationCode: null
  ...
  // "issueOrg": "string",
  // "regulationType": "string",
  // "issueDate": "2019-06-12T03:58:08.801Z",
  // "content": "string",
  // "guid": "string"
      this.deleteSum(this.data,['lastUpdateUserCode'])
