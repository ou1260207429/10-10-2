...
export const SERVER_URL= IS_DEBUG ? 'http://192.168.10.151:8087/' : 'http://dn5.gxcic.net:8301/';

export const FLOW_SERVICES_URL = IS_DEBUG ? 'http://192.168.10.151:8087' : 'http://dn5.gxcic.net:8303';
