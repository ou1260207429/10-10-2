...
export class WorkMattersReviewApplyComponent implements OnInit {
  ...
  applay() {
    ...
    var flowTypeFlag;
    if (this.flowType == 2) {
      flowTypeFlag = "xfys"+(this.reviewFormDto.flowTemplateSuffix? this.reviewFormDto.flowTemplateSuffix:"");
    } else {
      flowTypeFlag = "jgys"+(this.reviewFormDto.flowTemplateSuffix? this.reviewFormDto.flowTemplateSuffix:"");
    }
