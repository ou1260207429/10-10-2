...
export class FormDownloadDetailComponent implements OnInit {
  ...
  constructor(private _publicServices:PublicServices,private http: HttpClient, private _eventEmiter: EventEmiter, private message: NzMessageService, private _attachmentServiceProxy: AttachmentServiceProxy, private _activatedRoute: ActivatedRoute) {
  }
  ngOnInit() {
  ...
  uploadFiles() {
    ...
    // this.http.request("POST", this.uploadUrl, this.uploadParams)
    // const req = new HttpRequest('POST', this.uploadUrl, {params:this.uploadParams}, {
    //   // reportProgress: true
    // });
    // this.http
    //   .request(req)
