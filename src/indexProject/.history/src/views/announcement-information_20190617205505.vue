      ...
      <el-row :gutter="8">
        ...
        <el-col :span="20">
          <el-card style="padding:25px;">
            <el-form id="search" :inline="true" status-icon ref="searchForm">
              <el-form-item>
                <el-select
                  clearable
                  size="small"
...
export default {
  ...
  mounted() {
    ...
    const that = this;
    setTimeout(function() {
      that.tableHight = app.clentHeight()-that.$refs.searchForm.offsetHeight + "px";
    });
    window.onresize = function() {
      that.tableHight =app.clentHeight()-that.$refs.searchForm.offsetHeight+100 + "px";
    };
  },
  ...
  methods: {
    ...
    getInfo(type) {
      ...
      this.initTable();
      this.tableHight = app.clentHeight()-this.$refs.searchForm.offsetHeight + "px";
    },
    //切换省份查询区/县
    handleChange(value) {
      this.xianList = [];
