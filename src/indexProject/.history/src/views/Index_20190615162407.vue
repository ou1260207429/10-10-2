      ...
      <el-row :gutter="16">
        <el-col :span="12">
          ...
          <el-card class="box-card" style="min-height:270px;">
           ...
           <nz-card nz-card style="font-size:8px;height: 219px;">
          <p class="titleLeft"><span>法律法规</span></p>
          <div v-if="!lawsList" style="text-align: center;line-height: 30px;font-size: 30px">
            暂无数据
          </div>
          <div v-if="lawsList">
            <div nz-row style="padding:20px">
              <div :key="index" v-for="(item,index) in lawsList"
        ...
        <el-col :span="12">
          <el-card class="box-card">444</el-card>
        </el-col>
      </el-row>
    </div>
  </div>
...
.comeIn {
  ...
  letter-spacing: 4px;
  text-align: center;
  background: url("../assets/images/index1.jpg") no-repeat center;
}
