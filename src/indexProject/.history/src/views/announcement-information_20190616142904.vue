        ...
        <el-col :span="20">
          <el-card style="padding:20px;">
            <el-form :inline="true" status-icon ref="searchForm">
              <el-form-item>
                <el-select clearable size="small" @change="handleChange" v-model="searchForm.sheng" placeholder="请选择（市）">
                  <el-option
              ...
              <el-form-item>
                <el-button size="small" style="background-color:#bd1127ff;border-color:#bd1127ff;" type="primary" @click="initTable">提交</el-button>
              </el-form-item>
            </el-form>
          </el-card>
