      ...
      <el-row :gutter="16">
        <el-col :span="12">
         ...
         path: '/handling-guid-list-detail/'+item.id, 
          ...
          <el-card ref="leftbottom" :style="{marginTop:'8px', position: 'relative'}">
            <div style="overflow:hidden;">
              <p class="tips" style="float: left">
...
export default {
  ...
  methods: {
    initHeight() {
      ...
      console.log(_this.$refs.leftbottom.offsetHeight)
      _this.$refs.leftbottom.style.offsetHeight = resHeight - leftheight - 50 + "px";
    },
    getlawsList() {
      let _this = this;
