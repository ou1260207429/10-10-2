...
<template>
  <div style="width:100%;overflow:hidden;">
    <div class="content">
      <el-row :gutter="16">
        <el-col :span="12">
          <div  id="banner" class="comeIn">消防设计审查和验收办事入口</div>
          <el-card >
            ...
            <el-row id="leftTop" :gutter="50" style="padding:20px 40px;overflow:hidden;">
              <el-col
                class="item"
                :span="8"
                :key="index"
         ...
         path: '/handling-guid-list-detail/'+item.id, 
          ...
          <el-card :style="{minHeight:tabHeight.leftHeight,marginTop:'8px', position: 'relative'}">
            <div style="overflow:hidden;">
              <p class="tips" style="float: left">
        ...
        <el-col :span="12">
          ...
          <el-card :style="{minHeight:tabHeight.rightHeight,marginTop:'8px', position: 'relative'}">
            <div style="overflow:hidden">
              <p class="tips" style="float: right">
