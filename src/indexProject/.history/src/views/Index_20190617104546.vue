...
export default {
  data() {
    return {
      lawsList: [],
      tableList: [],
      handleImg:[require("../assets/images/img_zn_sjsc.png"),require("../assets/images/img_zn_xfys.png"),require("../assets/images/img_zn_jgys.png")],
      handleList: [
        {
          type: "Audit",
          name: "建设工程消防设计审核指南",
    ...
    initHandleList() {
      ...
      app.post(handle.search_handleList, app.pageSize).then(req => {
           req.result.data.forEach(item=>{
             console.log(item.title.indexOf("设计"))
            if(item.title.indexOf("设计")){
