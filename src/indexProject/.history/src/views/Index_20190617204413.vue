        ...
        <el-col :span="12">
          <div ref="leftTop">
            <el-card class="comeIn">
              <img src="../assets/images/img_bg_bsrk.png" alt>
              <p>消防设计审查和验收办事入口</p>
            </el-card>
            <el-card>
        ...
        <el-col :span="12">
          <el-card style="position: relative;">
            <div ref="rightTop">
              ...
              <el-row :gutter="50" style="padding:25px 40px;" class="listParent">
...
export default {
  ...
  methods: {
    initHeight(obj) {
      ...
      _this.leftHeight = resHeight - leftheight - 20 + "px";
      _this.rightHeight = resHeight - rightheight - 20 + "px";
    },
    getlawsList() {
      let _this = this;
