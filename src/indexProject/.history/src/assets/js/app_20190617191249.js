...
var app = {
  indexHeight(){
    ...
    let leftTophHeight = document.getElementById('leftTop') ? document.getElementById('search').clientHeight + 20 : 0;
    let contentHeight = clientHeight - topHeight - navHeight - searchHeight - 80 + 'px';
