...
var app = {
  indexHeight() {
    ...
    let bannerHeight = document.getElementById('banner') ? document.getElementById('banner').clientHeight : 160;
    let leftTophHeight = document.getElementById('leftTop').clientHeight ? document.getElementById('leftTop').clientHeight : 0;
    let rightTophHeight = document.getElementById('rightTop') ? document.getElementById('rightTop').clientHeight : 0;
    let leftHeight = clientHeight - topHeight - navHeight - leftTophHeight - bannerHeight - 80 + 'px';
    let rightHeight = clientHeight - topHeight - navHeight - rightTophHeight - 80 + 'px';
    console.log(leftHeight)
    console.log(leftTophHeight)
    let contentHeight = {
  ...
  clentHeight() {
    ...
    if (document.getElementById('banner')) {
      bannerHeight = document.getElementById('banner').clientHeight <150 ? 240 : document.getElementById('banner').clientHeight;
    }
