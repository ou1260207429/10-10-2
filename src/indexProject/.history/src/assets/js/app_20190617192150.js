...
var app = {
  indexHeight() {
    ...
    let bannerHeight = 0;
    console.log(document.getElementById('banner').clientHeight)
    if (document.getElementById('banner')) {
      bannerHeight = document.getElementById('banner').clientHeight == 94 ? 240 : document.getElementById('banner').clientHeight;
    }
