...
var app = {
  clentHeight() {
    ...
    console.log(topHeight+navHeight+bannerHeight)
    console.log(clientHeight - topHeight - navHeight - bannerHeight)

    let contentHeight = clientHeight - topHeight - navHeight - bannerHeight - 200 + 'px';
