...
namespace RJGF.GXZJT.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        private readonly GXZJTDbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(GXZJTDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new GXZJTAuthorizationProvider())
